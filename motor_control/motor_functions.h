...
#define CONTROL_SAMPLE_RATE 200  //hz

/*Velocidades*/
#define VEL_ANG_MAX 8.976  //Experimental en rad/s
...
void inspiracionVolumen(int frecuenciaRespiracion, double ratio, float volumen, float* recorridoAngularAddr);
